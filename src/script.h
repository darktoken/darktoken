...
#ifndef H_darktoken_SCRIPT
#define H_darktoken_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CdarktokenAddress
 */
...
public:
    ...
    // Pre-version-0.6, darktoken always counted CHECKMULTISIGs
