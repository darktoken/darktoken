...
#ifndef darktoken_MAIN_H
#define darktoken_MAIN_H
...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 2 * CENT;	// 2% annual interest
...
static const uint256 hashGenesisBlock("0x000002b511f55fce01d07fe73f53d311a395a4230de15ff96b648a96add0633c");
...
public:
    ...
    {
        // darktoken: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of darktokens spent by this transaction.
    ...
    /** Amount of darktokens coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // darktoken: get transaction coin age
...
public:
    ...
    // darktoken: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // darktoken: two types of block: proof-of-work or proof-of-stake
    ...
    // darktoken: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // darktoken: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // darktoken: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // darktoken: block index flags
    enum  
    {
