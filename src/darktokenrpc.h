...
#ifndef _darktokenRPC_H_
#define _darktokenRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // darktoken is not connected
...
/**
 * darktoken RPC command dispatcher.
 */
class CRPCTable
{
private:
